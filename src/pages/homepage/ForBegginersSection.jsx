        ...
        sx={{
            ...
            <SectionContainer backgroundColor={colors.mainbackground}>
                <Box
                    ...
                    marginBlock="50px"
                >
                    <Typography color={colors.textPrimary} variant="h2" sx={{alignSelf: {xs: "center", md: "start"}}}>For Beginners</Typography>
                    <CardSlider dataType="beginners"/>
...
export default ForBegginersSection